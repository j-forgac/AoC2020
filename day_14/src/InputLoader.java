public class InputLoader {
	...
	public static String[][] getInput() {
		for(int x = 0; x < input.length; x++){
			if(input[x].contains("mask")){
				processedInput[x][0] = "mask";
				processedInput[x][1] = input[x].substring(7);
				System.out.println(processedInput[x][0]);
				System.out.println(processedInput[x][1]);
			} else {
				processedInput[x] = input[x].split(" = ");
				processedInput[x][0] = processedInput[x][0].replaceAll("\\D+","");
				System.out.println(processedInput[x][0].replaceAll("\\D+","") + " | " + processedInput[x][1]);
			}
		}
	...
	public static String[][] getInput2() {
		for(int x = 0; x < input.length; x++){
			if(input[x].contains("mask")){
				processedInput[x][0] = "mask";
				processedInput[x][1] = input[x].substring(7).toString();
				currentMask = processedInput[x][1];
			} else {
				processedInput[x] = input[x].split(" = ");
				processedInput[x][0] = Integer.toBinaryString(Integer.parseInt(processedInput[x][0].replaceAll("\\D+","")));

				String maskedValue =processedInput[x][0];
				String beginning = "";
				for (int i = 0; i < currentMask.length() - maskedValue.length(); i++) {
					beginning += "0";
				}
				processedInput[x][0] = beginning + maskedValue;
			}
			if(debug == 1){
				System.out.println(processedInput[x][0] + " | " + processedInput[x][1]);
			}
		}
		return processedInput;
	}
